...
extern void render(struct gfx_context_t *context, cell_t **cells, int nb_cells, food_t **foods, int nb_foods);
extern void gfx_drawcircle(struct gfx_context_t *ctxt, int xc, int yc, int r, uint32_t color);
extern void gfx_drawcircle_food(struct gfx_context_t *ctxt, int xc, int yc, int r, uint32_t color);
#endif
